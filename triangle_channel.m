...
x_I=i*A_cell; %Stack current (A/cm^2)
O2=0.21; %O2 constant in the air
...
Dh=(wc.*sin(3.14/3))./(1+sin(3.14/6)); %rectanggular flowfield
...
P_atm=P.*9.86923e-6; %Convert from Pa to atm
